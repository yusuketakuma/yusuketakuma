...
薬剤師 × プログラマー — 在宅訪問薬局・薬局業務効率化・SaaS開発

## プロダクト

### 🏪 [DeadStockSolution](https://github.com/yusuketakuma/DeadStockSolution)
薬局間のデッドストック交換を自動化するSaaS。AIマッチングで滞留在庫の削減と廃棄損失を抑制。
🔗 [dead-stock-solution.vercel.app](https://dead-stock-solution.vercel.app)

### 💊 [CareViaX](https://github.com/yusuketakuma/careviax)
在宅訪問薬局向け業務・連携プラットフォーム（3省2ガイドライン準拠）
...
### 📋 [薬剤師無料ツール集](https://github.com/yusuketakuma/pharma-free-tools)
...
- **薬学**: 調剤・服薬指導・在宅訪問・DI・レセプト返戣
- **開発**: TypeScript / Next.js / React / Node.js / PostgreSQL
- **インフラ**: Vercel / Azure / GitHub Actions / Stripe
